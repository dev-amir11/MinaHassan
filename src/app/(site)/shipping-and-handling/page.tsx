...
export default function Page() {
  return (
    <InfoPage
      ...
      paragraphs={[
        "Mina Hasan partners with logistics providers for domestic and international deliveries. Dispatch timelines vary because pieces are predominantly made-to-order.",
        ...
        "For delivery questions, WhatsApp +92 324 341 7213 or email info@minahasan.com.",
      ]}
    />
  );
}
